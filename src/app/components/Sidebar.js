        ...
        <div className="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
            <ul className="space-y-2 font-medium">
               <li className={`py-1 ${activeLink === '/dashboard/main' ? 'bg-blue-700 text-white' : 'bg-white text-gray-700'}`}>
                  <Link href="/dashboard/main" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white  dark:hover:bg-cyan-700">
                     <svg aria-hidden="true" className={`w-6 h-6 transition duration-75 ${activeLink === '/dashboard/main' ? 'text-white' : 'text-gray-500'} dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white`} fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" 
                     ...
                     <span className={`py-1 ${activeLink === '/dashboard/main' ? 'text-white ml-3' : 'ml-3'}`} >Main Dashboard</span>
                  </Link>
               </li>
            </ul>
            <ul className="space-y-2 font-medium">
               <li className={`py-1 ${activeLink === '/dashboard/accounts' ? 'bg-blue-700 text-white' : 'bg-white text-gray-700'}`}>
                  <Link href="/dashboard/accounts" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white  dark:hover:bg-cyan-700">
                     ...
                     <span className={`py-1 ${activeLink === '/dashboard/accounts' ? 'text-white ml-3' : 'ml-3'}`} >Users</span>
                  </Link>
               </li>
            </ul>
            <ul className="space-y-2 font-medium">
               <li className={`py-1 ${activeLink === '/dashboard/classes' ? 'bg-blue-700 text-white' : 'bg-white text-gray-700'}`}>
                  <Link href="/dashboard/classes" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white  dark:hover:bg-cyan-700">
                     <svg aria-hidden="true" className={`w-6 h-6 transition duration-75 ${activeLink === '/dashboard/classes' ? 'text-white' : 'text-gray-500'} dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white`} fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" 
